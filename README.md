...
└── Калории и нутриенты/          отдельный vault, открывается в Obsidian уже настроенным
    ├── Профиль ученика.md
    ├── Карта темы.md
    ├── Источники/                4 файла с уровнями доказательности
    ├── План обучения.md          чекбоксы «смогу рассчитать...»
    ├── Уроки/
