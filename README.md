...
**Личный наставник в Claude Code: курс по любой теме, от интервью и научных источников до связной базы знаний в Obsidian.**

Скажи «хочу изучить X». Дальше идёт интервью о цели и уровне, ресёрч источников с оценкой по пирамиде доказательности, карта темы из эталонов покрытия, согласованный план, уроки с retrieval-практикой и повторениями по расписанию, оценки и обратная связь по твоим ответам. На выходе растёт база знаний со связным графом понятий.
